...
//				RectangleSystem house=house(room.x,room.y,room.width,room.height,4,4);
				...
				for (Rectangle hroom : house.rectangles.values()) {
					...
					if (Chance.roll(70)) {
						...
						hroomCharacters.add(new GeneratorCharacterGroup("goblin","������",Chance.rand(1,3),0));
						hroomCharacters.add(new GeneratorCharacterGroup("goblinMage","������-���",Chance.rand(0,1)*Chance.rand(0,2),0));
						hroomCharacters.add(new GeneratorCharacterGroup("ogre","���",Chance.rand(0,1)*Chance.rand(0,1),0));
