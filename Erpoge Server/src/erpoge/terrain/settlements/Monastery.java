...
public class Monastery extends Building {
	public Monastery(TerrainGenerator settlement, int x, int y, int width,
			int height) {
		super(settlement, x, y, width, height, 3);
		...
		// Set start area
		this.location.setStartArea(mainRS.getRandomRectangle());
